...
- [Replit OpenAI Python integration](replit-openai-python.md) — use AI_INTEGRATIONS env vars with openai Python SDK; setupReplitAIIntegrations provisions them.
